        ...
        >
            <div className="max-w-7xl mx-auto px-4 flex justify-between items-center h-16">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    <Link to="/pricing" className="text-white hover:text-[var(--ter-color)]">Pricing</Link>
            ...
            >
                <div className="space-y-4">
                    ...
                    <Link to="/pricing" onClick={() => setIsMenuOpen(false)} className="block text-gray-700 hover:text-black transition">Pricing</Link>
